...
<div class="divBody">
  <div class="divContent">
    ...
    <c:otherwise>
     <a href="${pb.urlString}&pc=${pb.pc-1}" class="aBtn bold">上一页</a>
    </c:otherwise>
    </c:choose>
...
4. 如果end>tp, 让begin=tp-5, end=tp
 ...
 <c:forEach begin="${begin }" end="${end }" var="i">
   <c:choose>
   	  ...
   	  <c:otherwise>
   	    <a href="${pb.urlString }&pc=${i}" class="aBtn">${i }</a>
   	  </c:otherwise>
   </c:choose>
    ...
    <c:otherwise>
     <a href="${pb.urlString }&pc=${pb.pc+1}" class="aBtn bold">下一页</a> 
    </c:otherwise>
    </c:choose>
